...
LLM_CONFIG = {
    ...
    "meta-llama/Llama-3.2-1B-Instruct": LLMConfig(
        llm_batch_size=64, context_length=2048, sae_batch_size=2048, dtype=t.bfloat16
    ),
    # "meta-llama/Llama-3.1-8B-Instruct": LLMConfig(
    #     llm_batch_size=16, context_length=2048, sae_batch_size=2048, dtype=t.bfloat16
    # ),
    "meta-llama/Llama-3.1-8B-Instruct": LLMConfig(
        llm_batch_size=64, context_length=2048, sae_batch_size=4096, dtype=t.bfloat16
    ),
    "openai/gpt-oss-20b": LLMConfig(
        llm_batch_size=16, context_length=4096, sae_batch_size=4096, dtype=t.bfloat16
    ),
}
