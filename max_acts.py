...
"""
CUDA_VISIBLE_DEVICES=0 python max_acts.py \
  --model_name "openai/gpt-oss-20b" \
  --sae_path "/workspace/sae/gpt-oss-20b/runs/0_l03/openai_gpt-oss-20b_batch_top_k/resid_post_layer_3/trainer_0" \
  --layer_index 3 \
  --out_dir "/workspace/sae/gpt-oss-20b/feature_mining/resid_post_layer_3/trainer_0" \
  --ctx_len 2048 \
  --num_samples 500000
"""
...
class FeatureMiningConfig:
    ...
    sae_path: str = "/workspace/sae/gpt-oss-20b/runs/0_l03/openai_gpt-oss-20b_batch_top_k/resid_post_layer_3/trainer_0"
    layer_index: int = 3
    out_dir: pathlib.Path = pathlib.Path("/workspace/sae/gpt-oss-20b/feature_mining/resid_post_layer_3/trainer_0")
...
if __name__ == "__main__":
    from data_generator.custom_generator import hf_chat_dataset_to_generator, hf_dataset_to_generator
